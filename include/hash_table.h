...
void hash_table_set_number_of_reads(long long read_count, HashTable * hash);
void hash_table_add_number_of_reads(long long read_count, HashTable * hash);
long long hash_table_get_number_of_reads(HashTable * hash);
